...
- нижнее меню магазина собрано в один общий блок;
- возвращена иконка кнопки «Меню»;
- в кабинете владельца можно редактировать карточки товара и баннеры, загружая фото прямо с устройства;
- также можно вставлять ссылку на изображение вручную.
